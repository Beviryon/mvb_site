...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    socialMedia: Schema.Attribute.Component<'contact.social-link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workingHours: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    stats: Schema.Attribute.Relation<'manyToMany', 'api::stat.stat'>;
...
export interface ApiPortfolioItemPortfolioItem
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['R\u00E9sidentiel', 'Commercial', 'Terrain', 'R\u00E9novation']
    > &
      Schema.Attribute.Required;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    isFeatured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    lastUpdated: Schema.Attribute.DateTime & Schema.Attribute.DefaultTo<'now'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::property.property'
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    type: Schema.Attribute.Enumeration<['Vente', 'Location']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Create and manage blog tags';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
